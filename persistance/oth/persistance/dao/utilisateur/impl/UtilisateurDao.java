...
public class UtilisateurDao extends AbstractGenericDao<UtilisateurDo> implements IUtilisateurDao {
	 ...
	 * 
	 * @see
	 * grpb.persistance.dao.utilisateur.IUtilisateurDao#getUtilisateurByLogin(
	 * java.lang.String)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see grpb.persistance.dao.utilisateur.IUtilisateurDao#
	 ...
	 * 
	 * @see
	 * grpb.persistance.dao.utilisateur.IUtilisateurDao#findProfilByNom(java.
	 * lang.String)
	 */
	@Override

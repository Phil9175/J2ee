...
import grpb.metier.mapper.utilisateur.MapperUtilisateur;
import grpb.metier.util.Utility;
import grpb.persistance.bean.utilisateur.ProfilDo;
...
public class TestMapperUtilisateur {
	 ...
	 */
	@Test
	public void test_07_inscriptionDto_to_utilisateurDo_correct() throws MappingException, ParseException {
	...
	public void test_09_inscriptiondto_to_utilisateurdo_exception() throws MappingException, ParseException {
	 ...
	 */
	@Test
	public void test_13_editinfopersobyadmindto_to_utilisateurdo_accept() throws MappingException, ParseException {
	 ...
	 */
	@Test(expected = MappingException.class)
	public void test_15_editinfopersobyadmindto_to_utilisateurdo_exception() throws MappingException, ParseException {
		final EditInfoPersoByAdminDto editInfo = new EditInfoPersoByAdminDto();
		final UtilisateurDto utilisateurDto = new UtilisateurDto();
		utilisateurDto.setActif(false);
		utilisateurDto.setAdresse("5 rue de l'université");
